...
var codebaseIndexConfigSchema = z6.object({
  ...
  codebaseIndexEmbedderProvider: z6.enum(["openai", "ollama", "openai-compatible", "gemini", "mistral", "vercel-ai-gateway", "openrouter", "roo"]).optional(),
...
var codebaseIndexModelsSchema = z6.object({
  ...
  roo: z6.record(z6.string(), z6.object({ dimension: z6.number() })).optional()
});
