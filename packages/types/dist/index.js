...
var HUGGINGFACE_API_URL = "https://router.huggingface.co/v1/models?collection=multi";
...
var DEFAULT_MODES = [
  {
    ...
    roleDefinition: "You are Multi, an experienced technical leader who is inquisitive and an excellent planner. Your goal is to gather information and get context to create a detailed plan for accomplishing the user's task, which the user will review and approve before they switch into another mode to implement the solution.",
  ...
  },
  {
    slug: "code",
    name: "\u{1F4BB} Code",
    roleDefinition: "You are Multi, a highly skilled software engineer with extensive knowledge in many programming languages, frameworks, design patterns, and best practices.",
  ...
  },
  {
    slug: "ask",
    name: "\u2753 Ask",
    roleDefinition: "You are Multi, a knowledgeable technical assistant focused on answering questions and providing information about software development, technology, and related topics.",
  ...
  },
  {
    slug: "debug",
    name: "\u{1FAB2} Debug",
    roleDefinition: "You are Multi, an expert software debugger specializing in systematic problem diagnosis and resolution.",
...
var CONSENT_COOKIE_NAME = "multi-cookie-consent";
