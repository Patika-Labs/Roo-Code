...
export declare class ClaudeCodeHandler extends BaseProvider implements ApiHandler {
    ...
    getModel(): {
        id: "claude-sonnet-4-5" | "claude-sonnet-4-20250514" | "claude-opus-4-5-20251101" | "claude-opus-4-1-20250805" | "claude-opus-4-20250514" | "claude-3-7-sonnet-20250219" | "claude-3-5-sonnet-20241022" | "claude-3-5-haiku-20241022" | "claude-haiku-4-5-20251001" | "claude-sonnet-4-5-20250929[1m]";
        info: {
