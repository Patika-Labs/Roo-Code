...
// ../node_modules/.pnpm/i18next@25.2.1_typescript@5.8.3/node_modules/i18next/dist/esm/i18next.js
...
var setup_default = instance;

// api/providers/utils/openai-error-handler.ts
function handleOpenAIError(error, providerName) {
  if (error instanceof Error) {
    const msg = error?.error?.metadata?.raw || error.message || "";
    ...
    if (msg.includes("Cannot convert argument to a ByteString")) {
      return new Error(setup_default.t("common:errors.api.invalidKeyInvalidChars"));
    }
...
//# sourceMappingURL=chunk-6FUJN5E5.js.map
