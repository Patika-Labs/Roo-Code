...
export interface ClineSayTool {
    tool: "editedExistingFile" | "appliedDiff" | "newFileCreated" | "codebaseSearch" | "readFile" | "fetchInstructions" | "listFilesTopLevel" | "listFilesRecursive" | "listCodeDefinitionNames" | "searchFiles" | "switchMode" | "newTask" | "finishTask" | "generateImage" | "imageGenerated" | "runSlashCommand" | "updateTodoList";
    path?: string;
    diff?: string;
    content?: string;
    diffStats?: {
...
export declare const browserActions: readonly ["launch", "click", "hover", "type", "press", "scroll_down", "scroll_up", "resize", "close", "screenshot"];
